...
class mutex_instances extends Dataset
{
	public static $profile= array(
		...
		'header'=>array( 
			...
			'LOCKED_BY_THREAD_ID' => array(  'TABLE_CATALOG' => 'def', 'TABLE_SCHEMA' => 'performance_schema', 'TABLE_NAME' => 'mutex_instances', 'COLUMN_NAME' => 'LOCKED_BY_THREAD_ID', 'ORDINAL_POSITION' => '3', 'COLUMN_DEFAULT' => '', 'IS_NULLABLE' => 'YES', 'DATA_TYPE' => 'bigint',),
		)
	);
	public $data;
}
