...
EOFILE;
	 ...
	 $nginxVersion = ucfirst($_SERVER["SERVER_SOFTWARE"]);
		$mysqlVersionC = explode(' - ',ucfirst(mysqli_get_client_info()))[0];
...
<body>
	...
	<ul class="tools">
		...
		<li><a href="tools/adminer.php?server=localhost&username=root"><B>Adminer Database Manager</B></a></li>
		<li><a href="tools/reg.php"><B>Regular Expressions Tester</B></a></li>
		<li><a href="tools/xcache/"><B>PHP XCache Stats</B></a></li>
  ...
  <tr>
    ...
    <td><a href="http://wtriple.com/wtnmp?wtSrc=index">WT-NMP</a></td>
