...
<head>
  ...
  <title>Suite Space - Search Listings</title>
  ...
  <section id="content">
    <div class="container">
      ...
      <div class="toolbar clearfix">
        <h4>Listing Results (3,452)</h4>
        <div class="short-by">
          <select class="form-control js-selectbox" title="Sort by">
            <option>Name</option>
      ...
      <div class="row">
        <div class="col-sm-4 col-md-4">
          <div class="thumbnail teaser-block">
            <div class="thumb">
              <a href="listing-detail.php"><img src="https://static.myrealestatesite.co/prototype/assets/img/image-1.jpg" alt=""></a>
            </div>
        ...
        <div class="col-sm-4 col-md-4">
          <div class="thumbnail teaser-block">
            <div class="thumb">
              <a href="listing-detail.php"><img src="https://static.myrealestatesite.co/prototype/assets/img/image-2.jpg" alt=""></a>
            </div>
            <div class="caption panel-block">
              <h3>Bay Isles</h3>
