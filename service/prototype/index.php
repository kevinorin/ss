							...
							<div class="container">
								<div class="agent-detail text-center">
									<div class="agent-photo">
										<span>
											<img class="agentProfile" src="https://static.myrealestatesite.co/prototype/assets/img/agent-image-1.png" alt="">
										</span>
									</div>
  				...
  				<div class="row">
  					<div class="col-sm-6">
  						<div class="thumbnail teaser-block">
  							<div class="thumb">
  								<img src="https://static.myrealestatesite.co/prototype/assets/img/image-1.jpg" alt="">
  							</div>
  					...
  					<div class="col-sm-6">
  						<div class="thumbnail teaser-block">
  							<div class="thumb">
  								<img src="https://static.myrealestatesite.co/prototype/assets/img/image-2.jpg" alt="">
  							</div>
  							<div class="caption panel-block">
  								<h3>Bay Isles</h3>
  			...
  			<div class="col-sm-4">
  				<aside>
  					<div class="panel-block">
						...
						<div class="agent-photo">
							<span>
								<img class="agentProfile" src="https://static.myrealestatesite.co/prototype/assets/img/agent-image-2.png" alt="">
							</span>
						</div>
    		...
    		<div class="row">
    			<div class="col-md-6">
    				<div class="blog-teaser media">
    					<div class="media-left media-middle">
    						<div class="thumb">
    							<img src="https://static.myrealestatesite.co/prototype/assets/img/image-3.jpg" alt="">
    						</div>
    					</div>
    			...
    			<div class="col-md-6">
    				<div class="blog-teaser media">
    					<div class="media-left media-middle">
    						<div class="thumb">
    							<img src="https://static.myrealestatesite.co/prototype/assets/img/image-4.jpg" alt="">
    						</div>
    					</div>
    					<div class="media-body media-middle">
    						<div class="blog-text">
