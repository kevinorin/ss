...
class general_log extends Dataset
{
	public static $profile= array(
		'target' =>'general_log',
		'header'=>array( 
			'event_time' => array(  'TABLE_CATALOG' => 'def', 'TABLE_SCHEMA' => 'mysql', 'TABLE_NAME' => 'general_log', 'COLUMN_NAME' => 'event_time', 'ORDINAL_POSITION' => '1', 'COLUMN_DEFAULT' => 'CURRENT_TIMESTAMP(6)', 'IS_NULLABLE' => 'NO', 'DATA_TYPE' => 'timestamp',),
			...
			'thread_id' => array(  'TABLE_CATALOG' => 'def', 'TABLE_SCHEMA' => 'mysql', 'TABLE_NAME' => 'general_log', 'COLUMN_NAME' => 'thread_id', 'ORDINAL_POSITION' => '3', 'COLUMN_DEFAULT' => '', 'IS_NULLABLE' => 'NO', 'DATA_TYPE' => 'bigint',),
