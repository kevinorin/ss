...
class slow_log extends Dataset
{
	public static $profile= array(
		'target' =>'slow_log',
		'header'=>array( 
			'start_time' => array(  'TABLE_CATALOG' => 'def', 'TABLE_SCHEMA' => 'mysql', 'TABLE_NAME' => 'slow_log', 'COLUMN_NAME' => 'start_time', 'ORDINAL_POSITION' => '1', 'COLUMN_DEFAULT' => 'CURRENT_TIMESTAMP(6)', 'IS_NULLABLE' => 'NO', 'DATA_TYPE' => 'timestamp',),
			...
			'thread_id' => array(  'TABLE_CATALOG' => 'def', 'TABLE_SCHEMA' => 'mysql', 'TABLE_NAME' => 'slow_log', 'COLUMN_NAME' => 'thread_id', 'ORDINAL_POSITION' => '12', 'COLUMN_DEFAULT' => '', 'IS_NULLABLE' => 'NO', 'DATA_TYPE' => 'bigint',),
			'rows_affected' => array(  'TABLE_CATALOG' => 'def', 'TABLE_SCHEMA' => 'mysql', 'TABLE_NAME' => 'slow_log', 'COLUMN_NAME' => 'rows_affected', 'ORDINAL_POSITION' => '13', 'COLUMN_DEFAULT' => '', 'IS_NULLABLE' => 'NO', 'DATA_TYPE' => 'int',),
		)
	);
	public $data;
}
